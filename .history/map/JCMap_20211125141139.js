...
function initJCMap(target = 'map', options = {}) {
	...
	const layerTianDiTu = new TileLayer({
		...
		source: new XYZ({
			url:
				'http://t0.tianditu.gov.cn/vec_c/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX={z}&TILEROW={x}&TILECOL={y}&tk=' +
				token,
